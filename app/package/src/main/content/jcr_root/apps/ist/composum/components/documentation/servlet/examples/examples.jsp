...
<cpp:defineObjects/>
<cpp:container test="@{examples.editMode or not empty examples.elements}"
               var="examples" type="com.composum.pages.commons.model.Container" scope="request">
    <sling:call script="examples.htl.html"/>
</cpp:container>
