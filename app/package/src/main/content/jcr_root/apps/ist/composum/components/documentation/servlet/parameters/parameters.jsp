...
<cpp:defineObjects/>
<cpp:container test="@{parameters.editMode or not empty parameters.elements}"
               var="parameters" type="com.composum.pages.commons.model.Container" scope="request">
    <sling:call script="parameters.htl.html"/>
</cpp:container>
